...
| `graph-agents-cli-langgraph-code` | LangGraph and LangChain patterns the template uses: create_agent and StateGraph, tools with PRODUCT_CALLS, checkpointers, streaming, interrupts, subgraphs, init_chat_model, the auth policy adapter, the product client |
