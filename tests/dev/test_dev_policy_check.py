...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('API_CALLS = [{"api": "a", "method": "POST", "path": "/x/cancel%20.json"}]\n', "a dot"),
        ('API_CALLS = [{"api": "a", "method": "POST", "path": "/x/cancel%3B"}]\n', "';'"),
        ('API_CALLS = [{"api": "a", "method": "POST", "path": "/x/cancel%2F"}]\n', "slash"),
        ('API_CALLS = [{"api": "a", "method": "POST", "path": "/x/cancel%5C"}]\n', "backslash"),
